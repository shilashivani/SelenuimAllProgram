...
public class AbsoluteXpath {
	...
	pass.sendKeys("12345");
//	WebElement button=driver.findElement(By.xpath("/html/body/div/div/div/div/div/div/div[2]/div/div/form/div[2]"));
	//button.click();
	//WebElement forgot=driver.findElement(By.xpath("/html/body/div/div/div/div/div/div/div[2]/div/div/form/div[3]"));
	//forgot.click();
	WebElement create=driver.findElement(By.xpath("/html/body/div/div/div/div/div/div/div[2]/div/div/form/div[5]"));
	create.click();
	}
